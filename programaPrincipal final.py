...
def crearListas():
    ...
    #Verifica el numero de maquinas que hay en el sistema, las designa como libres y con el trabajo artificial "0"   
    # Luego lo guarda en una lista, un elemento por cada maquina     
    for i in range(1,ordenMaquinas.shape[1]+1):
        maquina=Maquina(i,0,EstadoMaquina.LIBRE)
        maquinas.append(maquina)
    #Recorre la matriz de maquinas y de tiempos de procesamiento fila por fila y los asigna al respectivo trabajo
    # Luego lo guarda en una lista, un elemento por cada trabajo 
...
###################################################################################################################################
#Funciones del progrma inicial (comparte algunas con la implementacion ACO)
###################################################################################################################################

#Funciones para encontrar los ciclos y programarlos
...
#Esta funcion toma un ciclo encontrado y programa los trabajos 
...
# Progrma principal para la implementacion sin ACO
    ...
    while pendiente:
        ...
        for maquina in ordenIteracion:
            ...
            if maquina.estadoMaquina==EstadoMaquina.BLOQUEO:
                # Se requiere hallar la existencia de ciclos y programarlo
            ...
            #Caso no bloqueo (la maquina actual esta libre)
...
####################################################################################################################
# Implementacion de los diagrmas de gantt y frecuencia 
####################################################################################################################   
